  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "مطعم متخصص في تقديم سندوتشات الفلافل، اللحوم والمشويات، الكفتة، الشيش طاووق، البرجر، الوجبات العائلية، الدجاج، والمعجنات بالإسماعيلية.",
        "url": `${baseUrl}/`,
        ...
        "address": {
          ...
          "addressRegion": "Ismailia Governorate",
          "addressCountry": "EG"
        },
...
function renderQuickFacts() {
  return `<section class="geo-quick-facts" id="restaurant-facts" aria-label="معلومات وحقائق سريعة عن مطعم فالح أبو العنبة">
    ...
    <dl class="geo-facts-list">
      ...
      <div class="geo-fact-item">
        <dt>الموقع الجغرافي والعنوان:</dt>
        <dd>محافظة الإسماعيلية، جمهورية مصر العربية - <a href="https://maps.app.goo.gl/DqNEo521pyEbMpD49" target="_blank" rel="noopener noreferrer">عرض الموقع المباشر على خرائط جوجل</a></dd>
      </div>
      <div class="geo-fact-item">
        <dt>طرق الدفع والعملة:</dt>
        <dd>الدفع نقدًا (Cash) بالجنيه المصري (EGP).</dd>
      </div>
      <div class="geo-fact-item">
