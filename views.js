    ...
    <div class="card">
      ...
      <div class="card-content">
        ...
        <div class="actions">
          ...
          <a href="/delete-menu" class="btn btn-danger">
            <span class="icon">🗑️</span>
            حذف المنيو القديم
          </a>
        </div>
...
<body>
  ${data.menuExists ? `
    ...
    <div class="action-buttons">
      <a href="/menu.pdf" class="btn btn-primary" download>
        <span class="icon">📥</span>
        تحميل
      </a>
      ...
      async function loadPDF() {
        try {
          ...
          document.getElementById('pdfContainer').innerHTML = 
            '<div style="text-align: center; padding: 2rem;"><p>حدث خطأ في تحميل المنيو. يرجى <a href="/menu.pdf" download>تحميل الملف</a> مباشرة.</p></div>';
        }
      }
